  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center gap-4">
        ...
        <div className="h-10 w-32 animate-pulse rounded bg-[var(--card-border)]" />
      </div>
      <div className="overflow-hidden rounded-lg border border-[var(--card-border)] bg-[var(--card)]">
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          ...
          >
            <div className="h-4 w-32 animate-pulse rounded bg-[var(--card-border)]" />
            <div className="h-4 w-16 animate-pulse rounded bg-[var(--card-border)]" />
            <div className="h-4 w-12 animate-pulse rounded bg-[var(--card-border)]" />
